    ...
    a.fn.etalage = function(b) {
        ...
        a.each(this, function() {
            ...
            if (aG.is("ul") && aG.children("li").length && aG.find("img.etalage_source_image").length) {
                ...
                a.each(av, function() { a(this).data("src", this.src) });
                ...
                if (s !== "auto" && s && a(s).length) { K = a(s).addClass("etalage_zoom_area").html('<div><img class="etalage_zoom_img" /></div>') } else {
                    s = "auto";
                ...
                if (q > 1 || !c.smallthumb_hide_single) {
                    ...
                    if (q > aj) {
                        ...
                        } else { aV.eq(0).addClass("etalage_smallthumb_first etalage_smallthumb_active").css({ opacity: 1 }) }
                ...
                if (c.show_icon) {
                    aw = { top: O - E.outerHeight(true) - parseInt(c.icon_offset, 10), left: parseInt(c.icon_offset, 10) };
                ...
                if (q > 1 || !c.smallthumb_hide_single) {
                    ...
                    if (aL > 0) {
                        for (ad = 1; ad <= (y - 1); ad = ad + (aj - 1)) {
                            ab = 1;
                            for (ab; ab <= aL; ab += 1) {
                                if (aF === "vert") { aV.eq(ad + ab - 1).css({ marginBottom: (P - 1) }) } else { aV.eq(ad + ab - 1).css({ marginRight: (P - 1) }) }
                            }
                        }
                    } else {
                        if (aL < 0) {
                ...
                function aP(a2) {
                    ...
                    if (z) {
                        if (a2 === "left") { a3.trigger("click") } else { j.trigger("click") }
                    } else {
                ...
                function m(a5) {
                    ...
                    if (a5 === "end") {
                        ...
                        a4 = j;
                        if (j.hasClass("etalage_smallthumb_navtostart")) { a4 = j.prev() }
                    } else {
